        ...
        <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
            <div class="row bg-light rounded-3" id="login-group">
                ...
                <div class="row text-center">
                    <div class="col mt-3">
                        <h3 class="fw-bold">Daily Jobs Login</h3>
                    </div>
                </div>
                <form action="/login" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" aria-describedby="email" name="email" placeholder="Input Email">
                      @error('email')
                    ...
                    <button type="submit" class="btn btn-primary w-100 mt-3 mb-3">Sign In</button>
                    <p class="text-center">New Account, Please <a href="/register"> Register </a></p>
                    <hr>
                  </form>
